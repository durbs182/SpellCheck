...
namespace HtmlHelp.Storage
{
    ...
    public class ITStorageWrapper : IBaseStorageWrapper
    {
		...
		/// <summary>
		/// Opens an System.Runtime.InteropServices.ComTypes.IStream and returns the associated file object
		/// </summary>
		...
		public FileObject OpenUCOMStream(Interop.IStorage parentStorage, string fileName)
		{
			...
			try
			{
				...
				System.Runtime.InteropServices.ComTypes.IStream uCOMIStream = parentStorage.OpenStream(sTATSTG.pwcsName, IntPtr.Zero, 16, 0);
