...
namespace HtmlHelp
{
    public class Interop
    {
        ...
        public interface IEnumSTATSTG
        {
            ...
            /// <returns>Returns S_OK if succeeded</returns>
            int Next(int celt, out System.Runtime.InteropServices.ComTypes.STATSTG rgVar, out int pceltFetched);
        ...
        public interface ILockBytes
        {
            ...
            /// <summary>
            /// Retrieves a System.Runtime.InteropServices.ComTypes.STATSTG structure containing information for this byte array object.
            /// </summary>
            /// <param name="pstatstg">Location for System.Runtime.InteropServices.ComTypes.STATSTG structure</param>
            /// <param name="grfStatFlag">Values taken from the STATFLAG enumeration</param>
            void Stat(ref System.Runtime.InteropServices.ComTypes.STATSTG pstatstg, int grfStatFlag);
        }
        ...
        public interface IStorage
        {
            ...
            System.Runtime.InteropServices.ComTypes.IStream CreateStream([MarshalAs(UnmanagedType.BStr)] string pwcsName, [MarshalAs(UnmanagedType.U4)] int grfMode, [MarshalAs(UnmanagedType.U4)] int reserved1, [MarshalAs(UnmanagedType.U4)] int reserved2);
            ...
            /// <returns>Returns S_OK if succeeded</returns>
            [return: MarshalAs(UnmanagedType.Interface)]
            System.Runtime.InteropServices.ComTypes.IStream OpenStream([MarshalAs(UnmanagedType.BStr)] string pwcsName, IntPtr reserved1, [MarshalAs(UnmanagedType.U4)] int grfMode, [MarshalAs(UnmanagedType.U4)] int reserved2);
            ...
            void SetElementTimes([MarshalAs(UnmanagedType.BStr)] string pwcsName, System.Runtime.InteropServices.ComTypes.FILETIME pctime, System.Runtime.InteropServices.ComTypes.FILETIME patime, System.Runtime.InteropServices.ComTypes.FILETIME pmtime);
            ...
            /// <summary>
            /// Retrieves the System.Runtime.InteropServices.ComTypes.STATSTG structure for this open storage object.
            /// </summary>
            /// <param name="pStatStg">Ouput System.Runtime.InteropServices.ComTypes.STATSTG structure</param>
            /// <param name="grfStatFlag">Values taken from the STATFLAG enumeration</param>
            /// <returns>Returns S_OK if succeeded</returns>
        ...
        public interface ITStorage
        {
            ...
            /// <param name="pmtime">New modification time for element, or NULL</param>
            /// <returns>Returns S_OK if succeeded</returns>
            int StgSetTimes([MarshalAs(UnmanagedType.BStr)] string lpszName, System.Runtime.InteropServices.ComTypes.FILETIME pctime, System.Runtime.InteropServices.ComTypes.FILETIME patime, System.Runtime.InteropServices.ComTypes.FILETIME pmtime);
